...
function createAdmin($request_values){
	...
	if (empty($username)) { array_push($errors, "Enter a vlaid username"); }
	if (empty($email)) { array_push($errors, "Enter an email address"); }
	if (empty($role)) { array_push($errors, "Select a role");}
